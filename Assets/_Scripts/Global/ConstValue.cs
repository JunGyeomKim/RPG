...
public static class ConstValue 
{
	...
	public const string LocalSave_UseUInstance = "USE_INSTANCE";
	//Actor
	public const string LocalSave_ActorInstance = "ACTOR_INSTANCE";

	public const string LocalSave_PlayerGoodsInstance = "PLAYER_GOODS_INSTANCE";
