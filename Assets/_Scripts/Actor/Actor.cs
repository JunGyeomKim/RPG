...
public class Actor : BaseObject
{
    ...
    bool IsSpecter = false;
    public bool IS_SPECTER
    {
        get { return IsSpecter; }
        set { IsSpecter = value; }
    }
    ...
    [SerializeField]
    eAIType AIType = eAIType.AI_NORMAL;
	...
	private void Awake()
	{
        ...
        switch (AIType)
        {
            case eAIType.AI_NORMAL:
                ...
                break;
            case eAIType.AI_PLAYER:
                aiObject.name = "PlayerAI";
                Ai = aiObject.AddComponent<PlayerAI>();
                break;
            case eAIType.AI_SPECTER:
                aiObject.name = "SpecterAI";
                Ai = aiObject.AddComponent<SpecterAI>();
                break;
        }
	...
	public override void ThrowEvent(string keyData, params object[] datas)
	{
		if(keyData == ConstValue.EventKey_Hit)
		{
            ...
            if(OBJECT_STATE == eBaseObjectState.STATE_DIE)
            {
                ...
                GameManager.Instance.KillCheck(this);//킬체크.
            ...
            if (IsPlayer)
            {
                InGameUIManager.Instance.UI_ingame.SetDataHit(ConstValue.SetData_HP, GetStatusData(eStatusData.MAX_HP), SelfCharacter.CURRENT_HP);
            }
